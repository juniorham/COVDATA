...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        initComponents();
         ...
         try {
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/getbetter_db", "root", "Madman0208");
         ...
         jPanel5.setIcon(Img);
         jPanel5.setBounds(10, 53, 166, 256);
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Copyright@2022");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jLabel37, javax.swing.GroupLayout.PREFERRED_SIZE, 265, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(242, 242, 242))
        );
    ...
    private void loginbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginbtnActionPerformed
        Employee employee = new Employee(stmt);
        
        String username = this.username.getText();
        String password = this.password.getText();
        Boolean result = employee.login(username, password);
        
        if (result) {
            dispose();
            Dashboard db = new Dashboard(stmt);
            db.setVisible(true);
        } else {
